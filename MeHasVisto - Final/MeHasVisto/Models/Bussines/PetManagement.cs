...
namespace MeHasVisto.Models.Bussines
{
    public class PetManagement
    {
        public static void CreateThumbNail(
            ...
            bool maintainAspect)
        {
            //No hacer nada si el tamaño original
            //es mas pequeño que el designado al
            ...
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(thumbnail))
                {
                    ...
                    var thumnailName = Path.Combine(filePath, "thumbnail_" + fileName);
                    thumbnail.Save(thumnailName);
                }
            }
            catch { }
       }
